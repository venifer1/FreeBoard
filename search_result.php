...
<div class="main_wrap">
    ...
    <div id=makeSpace class="container">
        <table class="table table-striped">
            ...
            /*페이지,블록 개수*/
            $sql = mq("select * from board where $category like '%$search_con%'");
            ...
            $sql2 = mq("select * from board where $category like '%$search_con%' order by no desc limit $start_num, $list");
        ...
        <div id="ios5" class="paging">
            <ul>
                ...
                if($page <= 1){
                    ...
                    echo "<li class='lijs'><a  href='?page=1&catgo=$category&search=$search_con'>처음</a></li>";
                }
                if($page <= 1){}
                else{
                    $pre = $page-1;
                    echo "<li class='lijs'><a href='?page=$pre&catgo=$category&search=$search_con'>이전</a></li>";
                }
                ...
                for($i=$block_start; $i<=$block_end; $i++){
                    ...
                    if($page == $i){
                        ...
                        echo "<li class='lijs'><a href='?page=$i&catgo=$category&search=$search_con'>[$i]</a></li>";
                    }
                }
                ...
                if($block_num >= $total_block){}
                    ...
                    $next = $page + 1;
                    echo "<li class='lijs'><a href='?page=$next&catgo=$category&search=$search_con'>다음</a></li>";
                }
                ...
                if($page >= $total_page){
                    ...
                    echo "<li class='lijs'><a href='?page=$total_page&catgo=$category&search=$search_con'>마지막</a></li>";
                }
                ?>
            </ul>
        </div>
